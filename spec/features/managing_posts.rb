...
feature 'Managing blog posts' do 
  scenario 'Guest cannot create posts' do 
    visit root_path
    click_link 'New Post'
  ...
  scenario 'Posting a new blog' do 
    ...
    expect(page).to have_cntent 'New post'
  ...
  context 'with an existing blog post' do 
    background do@post = Post.create(:title => 'Awesome Blog Post', :body => 'Lorem ipsum dolor sit amet')
    end
